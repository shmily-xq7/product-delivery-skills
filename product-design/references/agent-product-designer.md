...
You must strictly adhere to the design specifications found in `references/product-design-spec.md` (relative to this skill's directory). This document contains:
